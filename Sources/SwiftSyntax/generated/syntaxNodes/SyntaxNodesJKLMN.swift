...
public struct MacroExpansionDeclSyntax: DeclSyntaxProtocol, SyntaxHashable, _LeafDeclSyntaxNodeProtocol {
  ...
  public init(
      ...
      _ unexpectedBetweenPoundAndModuleName: UnexpectedNodesSyntax? = nil,
      moduleName: TokenSyntax? = nil,
      _ unexpectedBetweenModuleNameAndPeriod: UnexpectedNodesSyntax? = nil,
      period: TokenSyntax? = nil,
      _ unexpectedBetweenPeriodAndMacroName: UnexpectedNodesSyntax? = nil,
    ...
    self = withExtendedLifetime((SyntaxArena(), (
            ...
            pound, 
            unexpectedBetweenPoundAndModuleName, 
            moduleName, 
            unexpectedBetweenModuleNameAndPeriod, 
            period, 
            unexpectedBetweenPeriodAndMacroName, 
            macroName, 
      ...
      let layout: [RawSyntax?] = [
          ...
          pound.raw, 
          unexpectedBetweenPoundAndModuleName?.raw, 
          moduleName?.raw, 
          unexpectedBetweenModuleNameAndPeriod?.raw, 
          period?.raw, 
          unexpectedBetweenPeriodAndMacroName?.raw, 
          macroName.raw, 
  ...
  public var unexpectedBetweenPoundAndModuleName: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 6)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  public var unexpectedBetweenPeriodAndMacroName: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 10)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
  ...
  public var genericArgumentClause: GenericArgumentClauseSyntax? {
    get {
      return Syntax(self).child(at: 13)?.cast(GenericArgumentClauseSyntax.self)
    }
    set(value) {
  ...
  public var arguments: LabeledExprListSyntax {
    get {
      return Syntax(self).child(at: 17)!.cast(LabeledExprListSyntax.self)
    }
    set(value) {
  ...
  public var rightParen: TokenSyntax? {
    get {
      return Syntax(self).child(at: 19)?.cast(TokenSyntax.self)
    }
    set(value) {
  ...
  public var trailingClosure: ClosureExprSyntax? {
    get {
      return Syntax(self).child(at: 21)?.cast(ClosureExprSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 21, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionDeclSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenTrailingClosureAndAdditionalTrailingClosures: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 22, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionDeclSyntax.self)
    }
  }
  
  public var additionalTrailingClosures: MultipleTrailingClosureElementListSyntax {
    get {
      return Syntax(self).child(at: 23)!.cast(MultipleTrailingClosureElementListSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 23, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionDeclSyntax.self)
    }
  }
  ...
  public func addAdditionalTrailingClosure(_ element: MultipleTrailingClosureElementSyntax) -> MacroExpansionDeclSyntax {
    var collection: RawSyntax
    let arena = SyntaxArena()
    if let col = raw.layoutView!.children[23] {
      collection = col.layoutView!.appending(element.raw, arena: arena)
    } else {
  ...
  public var unexpectedAfterAdditionalTrailingClosures: UnexpectedNodesSyntax? {
    get {
      return Syntax(self).child(at: 24)?.cast(UnexpectedNodesSyntax.self)
    }
    set(value) {
      self = Syntax(self).replacingChild(at: 24, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionDeclSyntax.self)
    }
  }
  ...
  public static var structure: SyntaxNodeStructure {
    return .layout([
          ...
          \Self.pound, 
          \Self.unexpectedBetweenPoundAndModuleName, 
          \Self.moduleName, 
          \Self.unexpectedBetweenModuleNameAndPeriod, 
          \Self.period, 
          \Self.unexpectedBetweenPeriodAndMacroName, 
          \Self.macroName, 
...
public struct MacroExpansionExprSyntax: ExprSyntaxProtocol, SyntaxHashable, _LeafExprSyntaxNodeProtocol {
  ...
  public var trailingClosure: ClosureExprSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 17, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionExprSyntax.self)
    }
  }
  ...
  public var unexpectedBetweenTrailingClosureAndAdditionalTrailingClosures: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 18, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionExprSyntax.self)
    }
  }
  ...
  public var additionalTrailingClosures: MultipleTrailingClosureElementListSyntax {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 19, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionExprSyntax.self)
    }
  }
  ...
  public var unexpectedAfterAdditionalTrailingClosures: UnexpectedNodesSyntax? {
    ...
    set(value) {
      self = Syntax(self).replacingChild(at: 20, with: Syntax(value), arena: SyntaxArena()).cast(MacroExpansionExprSyntax.self)
    }
  }
